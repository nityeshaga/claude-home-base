...
Usage:
    python3 multi_turn_chat.py [--model MODEL] [--output-dir DIR]
...
class ImageChat:
    ...
    def send_message(self, message: str, image: Optional[Image.Image] = None) -> Tuple[Optional[str], Optional[Image.Image]]:
    ...
    def save_image(self, filename: Optional[str] = None) -> Optional[str]:
