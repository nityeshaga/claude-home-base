...
Usage:
    python3 compose_images.py "instruction" output.png image1.png [image2.png ...]

Examples:
    python3 compose_images.py "Create a group photo of these people" group.png person1.png person2.png
    python3 compose_images.py "Put the cat from the first image on the couch from the second" result.png cat.png couch.png
    python3 compose_images.py "Apply the art style from the first image to the scene in the second" styled.png style.png photo.png
