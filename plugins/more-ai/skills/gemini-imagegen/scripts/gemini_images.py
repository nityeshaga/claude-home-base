...
Environment:
    GEMINI_API_KEY - Required API key (set via Claude Desktop environment settings)
"""
...
AspectRatio = Literal["1:1", "1:4", "1:8", "2:3", "3:2", "3:4", "4:1", "4:3", "4:5", "5:4", "8:1", "9:16", "16:9", "21:9"]
ImageSize = Literal["512", "1K", "2K", "4K"]
Model = Literal["gemini-3.1-flash-image-preview", "gemini-2.5-flash-image", "gemini-3-pro-image-preview"]
...
class GeminiImageGenerator:
    ...
    FLASH_STABLE = "gemini-2.5-flash-image"
