...
every place your skim-belief was wrong or missing something essential. Each of those is a
finding: either the page's heading/link/visual fails to carry the idea (Major), or the page
should have gated you and didn't (Major), or it's fine that a skimmer missed it (Minor).
Also flag any heading or link text that is a pun/tease that only makes sense *after*
reading — those are skim-hostile.
