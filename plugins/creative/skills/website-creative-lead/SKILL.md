---
name: website-creative-lead
description: Act as a creative lead for website design — thinking through purpose, story, and feeling before any code or implementation. Use this skill whenever the user wants to design a new website, landing page, product page, or web experience. Triggers include "design a website for", "creative direction for", "I need a landing page", "make this look amazing", "website redesign", "brand direction for our site", or any request where the user wants to go beyond functional design into something truly distinctive and memorable. Also use when the user references wanting a site that feels like a "place" or an "experience" rather than just a page, or when they want help thinking through the visual identity and atmosphere of a web project before building it.
---
